// Scroll down to the bottom for the exercise details
//
// NOTE: You may have to run this within VSCode.
// It's likely OneCompiler can't handle this enough
// to provide useful results. 
// 
// Choose one person as the Driver, and anothe person
// as the Data Recorder. 
...
// Tests to see if the sets "work" (at least, are consistent with each other)
...
let randValueRange = 10000;
let numValues = 100000000;
